...
{{--                                <th> {{localize('Action')}} </th>--}}
                            ...
                            @foreach ($orders as $info)
                                <tr>
                                    ...
                                    <td>
                                        <label
                                            class="badge {{ $info->is_paid ? 'badge-gradient-success' : 'badge-gradient-danger' }}">{{ $info->is_paid == 0 ? 'Unpaid' : 'Paid' }}</label>
                                    </td>
                                    <td>
                                        {{\Carbon\Carbon::parse($info->created_at)->format('d M, y h:m A')}}
                                    </td>
                                </tr>
                            @endforeach
