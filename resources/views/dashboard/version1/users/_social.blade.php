                    ...
                    <div class="col-lg-6">
                        <div class="form-group has-validation">
                            ...
                            <x-form.input type="text"
                                          ...
                                          value="{{ isset($user) ? $user->distributor?->facebook_link : old('facebook_link') }}"
                            />
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group has-validation">
                            ...
                            <x-form.input type="text"
                                          ...
                                          value="{{ isset($user) ? $user->distributor?->instagram_link : old('instagram_link') }}"
                            />
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group has-validation">
                            ...
                            <x-form.input type="text"
                                          ...
                                          value="{{ isset($user) ? $user->distributor?->tiktok_link : old('tiktok_link') }}"
                            />
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group has-validation">
                            ...
                            <x-form.input type="text"
                                          ...
                                          value="{{ isset($user) ? $user->distributor?->youtube_link : old('youtube_link') }}"
                            />
                        </div>
                    </div>
