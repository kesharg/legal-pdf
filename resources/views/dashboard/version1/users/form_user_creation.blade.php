                    ...
                    <div class="col-lg-4">
                        <div class="form-group has-validation">
                            ...
                            <x-form.input type="text"
                                          id="last_name"
                                          name="last_name"
                                          placeholder="{{ localize('Chowdhury') }}"
                    ...
                    <div class="col-lg-4">
                        <div class="form-group has-validation">
                            ...
                            <x-form.input type="text"
                                          id="username"
                                          name="username"
                                          placeholder="{{ localize('imranhossain') }}"
                    ...
                    <div class="col-lg-4">
                        <div class="form-group has-validation">
                            ...
                            <x-form.input type="text"
                                          id="email"
                                          name="email"
                                          placeholder="{{ localize('imran@gmail.com') }}"
                        ...
                        <div class="row">
                            @if(isset($user))
                                <div class="form-group">
                                    @if(isset($user->photo))
                                        <img src="{{ asset($user->photo) }}" alt="Previous Image" class="img-thumbnail"
