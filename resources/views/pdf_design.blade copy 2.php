...
<body>
        ...
        if (isset($data['messages'])) {
            ...
            foreach ($data['messages'] as $message) {
                ...
                if ($messageResponse) {
                    ...
                    $receiver = '';
                    $date = '';
                    $body = isset($messageData['snippet']) ? $messageData['snippet'] : '';

                    // Extracting headers information
    ...
    <section class="pdf-message-collection">
        ...
        <div class="message-counter-head" style="display: flex; justify-content: space-between">
            <div class="text-left">
                <p class="text-1">{{ sprintf('%02d', $messageCount + 1) }}</p>
            </div>
            ...
            <div class="text-center">
                ...
                @if (isset($language) && $language == 'heb')
                    <p><span class="label">נושא: </span><span class="content" dir="rtl">{{ $subject }}</span>
                    </p>
                @else
                    <p><span class="label">Subject:</span> <span class="content"
                            dir="rtl">{{ $subject }}</span></p>
                @endif
            </div>
        ...
        <div class="message-body">
            @php
                $decoded_message = strip_tags(html_entity_decode($body), '<br>');
