...
<div class="my-3 d-flex justify-content-between align-items-center" style="padding-left: 0;">
    <form action="{{ route('admin.languages.store') }}" method="POST" class="d-flex align-items-center"
        ...
        <div class="form-group mb-3" style="flex: 1; margin-right: 10px;">
            ...
            <select name="locale" onchange="this.form.submit()" class="form-control" required style="height: 38px;">
        ...
        <div class="form-group mb-3" style="flex: 1; margin-right: 10px;">
            ...
            <input type="text" id="sub_domain" class="form-control" name="sub_domain" placeholder="-" required
                style="height: 38px;">
        </div>
        <div class="form-group mb-3" style="flex: 1; margin-right: 10px;">
            <label for="language">Language</label>
            <select id="language" name="language" onchange="this.form.submit()" class="form-control" required
                style="height: 38px;">
                <option selected disabled> - </option>
        ...
        <div class="form-group mb-3" style="flex: 1; margin-right: 10px;">
            ...
            <select id="is_active" class="form-control" name="is_active" required style="height: 38px;">
                <option selected disabled> - </option>
